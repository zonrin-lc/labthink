...
echo.
echo 可用Skill:
echo   1. labthink-industry-solution-ppt    - 行业解决方案PPT制作（通用版）
echo   2. labthink-logo-wall                 - 企业Logo搜集与客户墙排版
echo   3. labthink-bid-review-portable       - 投标响应文件审阅复核（可移植版）
echo.
echo 请选择安装方式:
echo   A. 安装全部Skill
echo   B. 仅安装 labthink-industry-solution-ppt
echo   C. 仅安装 labthink-logo-wall
...
echo.
echo 开始安装全部Skill...
call :install_skill labthink-industry-solution-ppt
call :install_skill labthink-logo-wall
...
echo.
echo 各Skill详细说明:
echo   - skills\labthink-industry-solution-ppt\README.md
echo   - skills\labthink-logo-wall\README.md
echo   - skills\labthink-bid-review-portable\README.md
echo.
echo 注意事项:
echo   1. 请确保已配置飞书连接器授权（labthink-industry-solution-ppt需要）
echo   2. labthink-logo-wall内置示例Logo，实际使用需替换为真实企业Logo
